...
<body class="dark:bg-gray-900 bg-gray-100">
  <header class="bg-white shadow px-6 dark:bg-gray-800 border-b  border-gray-100 dark:border-gray-700" >
    <div class="flex justify-between h-16 items-center max-w-6xl mx-auto">
      {{-- menu --}}
      <button class="text-slate-500 hover:bg-sky-500 rounded p-1 transition-colors focus:ring-2 focus:right-slate-200">
    ...
    <section class="max-w-6xl mx-auto">
        <div class="relative" id="default-carousel" data-carousel="static">
            ...
            <div class="flex absolute bottom-5 left-1/2 z-30 space-x-3  -translate-x-1/2">
                <button type="button" class="md:w-3 md:h-3 w-2 h-2 rounded-full" aria-current="false" aria-label="Slide 1" data-carousel-slide-to="0"></button>
                <button type="button" class="md:w-3 md:h-3 w-2 h-2 rounded-full" aria-current="false" aria-label="Slide 2" data-carousel-slide-to="1"></button>
                <button type="button" class="md:w-3 md:h-3 w-2 h-2 rounded-full" aria-current="false" aria-label="Slide 3" data-carousel-slide-to="2"></button>
            </div>
        
            <button type="button" class=" md:flex absolute top-0 left-0 z-30 justify-center items-center px-4 h-full cursor-pointer group focus:outline-none" data-carousel-prev>
                <span class="inline-flex justify-center items-center w-6 h-6 rounded-full md:w-10 md:h-10 bg-white/30  group-focus:ring-2 group-focus:ring-white  group-focus:outline-none">
            ...
            <button type="button" class="md:flex absolute top-0 right-0 z-30 justify-center items-center px-4 h-full cursor-pointer group focus:outline-none" data-carousel-next>
                <span class="inline-flex justify-center items-center w-6 h-6 rounded-full sm:w-10 sm:h-10 bg-white/30 0 group-focus:ring-2 group-focus:ring-white  group-focus:outline-none">
